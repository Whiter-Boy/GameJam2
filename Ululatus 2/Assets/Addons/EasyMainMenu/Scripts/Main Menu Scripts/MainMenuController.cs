...
public class MainMenuController : MonoBehaviour {
    ...
    public void OptionsMenu()
    {
        if (!string.IsNullOrEmpty(optionsSceneName))
            ...
            Debug.Log("Please write a scene name in the 'optionsSceneName' field of the Main Menu Script and don't forget to " +
                "add that scene in the Build Settings!");
    }
    ...
    public void BackToMainMenu()
    {
        if (!string.IsNullOrEmpty(mainSceneName))
            ...
            Debug.Log("Please write a scene name in the 'mainSceneName' field of the Main Menu Script and don't forget to " +
                "add that scene in the Build Settings!");
    }
    ...
    public void Controls()
    {
        if (!string.IsNullOrEmpty(controlsSceneName))
            ...
            Debug.Log("Please write a scene name in the 'controlsSceneName' field of the Main Menu Script and don't forget to " +
                "add that scene in the Build Settings!");
    }
    #endregion
